...
export const RightPanel: React.FC<RightPanelProps> = ({
  ...
  return (
    <div className="fixed right-0 top-0 bottom-0 bg-nova-card/90 backdrop-blur-md border-l border-slate-700/50 p-4 z-[101] w-64 space-y-6 overflow-y-auto">
      ...
      {/* Style Panel (for selected shape) */}
      {selectedShape && (
        <div>
